...
<head>
	...
	<style type="text/css">
	.wrapper #wrapper .main .shell .content .list{margin-left:15px;}
	.wrapper #wrapper .main .shell .content .list li{
		list-style:decimal inside; font-family:Roboto,trebuchet ms,serif !important;
						font-size:16px; color:#333; padding:5px; text-indent:10px;
}
    </style>
...
<li><a href="full_post.php" style="padding:5px;">More Posts</a></li>
				...
				<div class="content" style="clear:both;">
				  ...
				  <h3>About Us</h3>
                 <!--   <p style="font-family:Roboto,trebuchet ms,serif !important; font-size:16px; color:#333;">FoxyCare.com is a healthcare free website.we provide u blog or post according to your choice and need.

<br></br>
"Health is wealth" 
</br></br>
In the world all people in going toward Max development and toward technology.
But your health is most precious in your development.
with the help of Foxycare you can motivate your self to being helthy.</p>
<a href="management.php"><button style="height:50px; width:180px; font-family:Roboto,trebuchet ms,serif !important; background:#ff9031; color:#FFF; margin:20px; float:right; border:0; ">Management Team</button></a>
			...
			-->
            <p style="font-family:Roboto,trebuchet ms,serif !important; font-size:16px; color:#333;">
            Hi</br>
Welcome Buddy</br></br>
Are you worried about Beauty and Health or you want collect information. You visited right website FoxyCARE.Com.</br></br>
We are dedicated to provide you Correct information as well as Latest articles.  </br>

</br></br>
Well </br>
According to your Need and Choice, you can browse all categories.  Let’s know our categories-</br></br></p>
<ul class="list">
<li>&nbsp;Medical care </li>
<li>&nbsp;Skin care</li>
<li>&nbsp;Hair care</li>
...
<li>&nbsp;First aid</li>
 ...
 <p style="font-family:Roboto,trebuchet ms,serif !important; font-size:16px; color:#333;">
<b>Our Free Answers-Questions Portal</b></br></br>

We started Answers-Questions Portal as LATEST QUESTIONS. You can ask your health related problems in Answers-Questions Portal, our Associated Health Experts will Answers.</br> </br>
