...
<head>
	<meta charset="utf-8" />
	<title>FoxyCare All Posts</title>
			...
			<div class="shell">
				...
				<nav id="navigation">
					<ul>
                        ...
                        <li><a href="category.php?cat=34">Medical Care</a></li>
...
$.post("hindi_post.php?action=get&last_msg_id="+ID,
function( data )
{
if (data != "") 
{
...
jQuery(
  function($)
  {
    $('.wrapper').bind('scroll', function()
                    ...
                    <?
$sql = mysql_query("SELECT * FROM `posts` WHERE `lang`='2' ORDER BY `id` DESC LIMIT 15");
...
{
 include("load_sec_full_post_hindi.php");
