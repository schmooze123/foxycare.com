...
<li><a href="full_post.php" style="padding:5px;">More Posts</a></li>
				...
				<div class="content" style="clear:both;">
				  ...
				  <h3>Management</h3>
                  <div style="height:100px; width:100px; border:1px solid #ccc; padding:2px; margin-right:5px;  float:left;"><img src="css/images/pp.jpg" style="height:100%; width:100%;"></div>
                    <p style="font-family:Roboto,trebuchet ms,serif !important; font-size:20px; padding:5px; color:#ff9031;">
                    Prajapati Ajay
                     </p>
                    
                    <p style="font-family:Roboto,trebuchet ms,serif !important; font-size:16px; padding:5px; color:#333;">Contact No: +918435106565</p>

                 
                 <a href="https://www.facebook.com/kuajayprajapati" target="_blank"> <img height="40" src="css/images/fb_button.png"></a>
                  <a href="https://twitter.com/pra_ajay" target="_blank"> <img height="40" src="css/images/twitter-button.png"></a><br>
                 
                 <br>
                  <div style="height:100px; width:100px; border:1px solid #ccc; padding:2px; margin-right:5px;  float:left;"><img src="css/images/AkoS_2Ai3jOKLahWQIOKsvsaS3EX8ghi9Uq3fsMfiB1b.jpg" style="height:100%; width:100%;"></div>
                    <p style="font-family:Roboto,trebuchet ms,serif !important; font-size:20px; padding:5px; color:#ff9031;">
                    Khyati Yadav
                     </p>
                    
                    <p style="font-family:Roboto,trebuchet ms,serif !important; font-size:16px; padding:5px; color:#333;">Email : Khyatibindas@yahoo.com</p>
                      <br>
                      <br><br>
                  <div style="height:100px; width:100px; border:1px solid #ccc; padding:2px; margin-right:5px;  float:left;"><img src="css/images/11713372_1859110177647341_1397128180_n.jpg" style="height:100%; width:100%;"></div>
                    <p style="font-family:Roboto,trebuchet ms,serif !important; font-size:20px;  color:#ff9031;">
                    Priyanshu Shrivastava
                     </p>
                     <p style="font-family:Roboto,trebuchet ms,serif !important; font-size:16px;  color:#333;">Website Developer/Designer</p>
                     <p style="font-family:Roboto,trebuchet ms,serif !important; font-size:16px;  color:#333;">Phn No : +91 0895936338</p>
                    
 <a href="https://www.facebook.com/priyanshu.shrivastava.9" target="_blank"> <img height="40" src="css/images/fb_button.png"></a>
                  <a href="https://twitter.com/priyanshu50" target="_blank"> <img height="40" src="css/images/twitter-button.png"></a><br>
